				...
				for(var sky1 in xml1){
					...
					if(sxml2.charAt(0)=='"'){
						...
						for(var sky2 in xml2){
							...
							if(sxml3.charAt(0)=='"'){
								...
								for(var aky3 in axml3){
									hm +="<option value=$." + key + "."+sky1+"."+sky2+"[*]."+aky3+">" + key + "/"+sky1+"/"+sky2+"/"+aky3+"</option>";
								}
							}else{
								hm +="<option value=$." + key + "."+sky1+"."+sky2+">" + key + "/"+sky1+"/"+sky2+"</option>";			
							}
						...
						for(var aky2 in axml2){
							...
							var xml3=JSON.parse(sxml3);
							if(sxml3.charAt(0)=='"'){
								hm +="<option value=$." + key + "."+sky1+"[*]."+aky2+">" + key + "/"+sky1+"/"+aky2+"</option>";
							}else if(sxml3.charAt(0)=='{'){
								for(var sky3 in xml3){
									hm +="<option value=$." + key + "."+sky1+"[*]."+aky2+"."+sky3+">" + key + "/"+sky1+"/"+aky2+"/"+sky3+"</option>";
								}
							}else if(sxml3.charAt(0)=='['){
								var axml3=xml3[0];
								for(var aky3 in axml3){
									hm +="<option value=$." + key + "."+sky1+"[*]."+aky2+"[*]."+aky3+">" + key + "/"+sky1+"/"+aky2+"/"+aky3+"</option>";
								}
							}else{
								hm +="<option value=$." + key + "."+sky1+"[*]."+aky2+">" + key + "/"+sky1+"/"+aky2+"</option>";			
							}
					...
					if(sxml2.charAt(0)=='"'){
						...
						for(var aky2 in axml2){
							...
							if(sxml3.charAt(0)=='"'){
								...
								var axml3=xml3[0];
								for(var aky3 in axml3){
									hm +="<option value=$." + key + "[*]."+aky1+"[*]."+aky2+"[*]."+aky3+">" + key + "/"+aky1+"/"+aky2+"/"+aky3+"</option>";
								}
							}else{
								hm +="<option value=$." + key + "[*]."+aky1+"[*]."+aky2+">" + key + "/"+aky1+"/"+aky2+"</option>";		
							}
